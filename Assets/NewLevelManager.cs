...
{
	private static NewLevelManager _instance;
   ...
   // public Transform enemyCombatTransform = null;
	...
	[SerializeField] private NewTransitionManager transitionMan; 
   ...
   public IEnumerator Transition()
    ...
    public void SetUpNewScene()
    {
        ...
        {
            _instance = Instance;
            _instance = FindObjectOfType<NewLevelManager>(); 
